      ...
      DOUBLE PRECISION :: TK,TA,TZ,PK,PA,P0,DGS,DG,OCV,AA,AK,CD0A, &
                          ...
                          MU,E,HI,SI,WA,EW,RHOI,SIGA,KAPPA
	...
	S(I)=SI
      ...
      SIGA=(0.005139D0*LAM-0.00326D0)*DEXP(1268.D0*((1.D0/ &
           303.D0)-(1.D0/TZ)))
           !SIGM=SIGM*100.D0      
      PRINT*,'SIGM=',SIGA
      ...
      IMPLICIT NONE
      !
      DOUBLE PRECISION :: TVIS,TZ,ETA
      !
      ETA20=1.002D-3
      TVIS=TZ-273.15D0
      ETA=ETA20*DEXP(((20.D0-TVIS)/(TVIS+96.D0))*(1.2378D0-1.303D-3* &
      ...
      !##################################################################
      !
      SUBROUTINE PROT(GASC,WA,EW,LAM,TZ,M,RHOI,MUW,KAPPA,SIGM)
      !
      IMPLICIT NONE
      !
      DOUBLE PRECISION :: SIGM,GASC,WA,EW,LAM,TZ,EPSI,RHOI,TAU,M,RW, &
                          DELTA,MUW,EPSR,EPS0,QE
      !
